  ...
  #getBaseCommands() {
    ...
    return [
      ...
      },
      {
        id: "AddCommentNode",
        title:
          "Add comment linked to the currently selected node in the current graph",
        hotkey: "Ctrl+Q",
